...
Title:    "Consent (Paronamix)"
Description: "This profile defines how the gaming results generated by the PANORAMIX project are shared using FHIR DocumentReference for supporting the scope of the Gatekeeper project in the Aragon Pilot"
//-------------------------------------------------------------------------------------------
* masterIdentifier MS
* status 1.. MS
* docStatus MS
