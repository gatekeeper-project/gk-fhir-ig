...
* item[0].item[2].answerOption[9].valueString = 	"Other:"
...
* item[2].item[0].text = " … have you been suspected of having COVID-19 infection?" 
...
* item[2].item[1].text = " … have you had any of the following symptoms? (check all that apply)" 
